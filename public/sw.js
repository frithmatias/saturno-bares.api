...
self.addEventListener('install', e => {
  let static = caches
    ...
    .then(cache => {
      ...
      return cache.addAll([
        '/',
        '/2.13e7124763383e8f25d1.js',
        '/6.60fa4730d1f627b162f7.js',
        '/7.269d64405ecbfcaaf44f.js',
        '/8.c603a759833412296bba.js',
        '/9.3744b16604a5a6166655.js',
        '/10.308ad75588c576caf1d6.js',
        ...
        '/runtime.fff8c5ec279a2ccb888f.js',
